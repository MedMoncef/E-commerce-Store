...
>(({ side = "right", className, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 flex h-full w-full max-w-md flex-col gap-6 border border-border bg-card p-6 shadow-xl transition",
        side === "right" && "right-0 top-0",
        side === "left" && "left-0 top-0",
        side === "top" && "left-0 top-0 h-1/2",
        side === "bottom" && "bottom-0 left-0 h-1/2",
        className
      )}
      {...props}
    />
